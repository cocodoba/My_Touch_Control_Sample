 ...
 */
public class BallPlayView extends View {
    private static final String TAG = BallPlayView.class.getSimpleName();
    private final BallPlayView self = this;
    ...
    public BallPlayView(Context context) {
        super(context);
        initialize();
    }
